...
import TrainingProgramOwnershipPage from "../TrainingProgramOwnershipPage/TrainingProgramOwnershipPage";
import TrainingProviderInformationPage from "../TrainingProviderInformationPage/TrainingProviderInformationPage";
import OfficerInChargePage from "../OfficerInChargePage/OfficerInChargePage";
import BusinessInformationPage from "../BusinessInformationPage/BusinessInformationPage";
import TrainerDetailsPage from "../TrainerDetailsPage/TrainerDetailsPage";
// ~cb-add-import~
...
<li
                onClick={() => {
                  setCurrentActiveTab2("cars");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "cars",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "cars" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "cars",
                      "text-black": props?.currentActiveTab2 !== "cars",
                    })}
                  >
                  Cars
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "cars",
                      "text-yellow-700": props?.currentActiveTab2 !== "cars",
                    })}
                  >
